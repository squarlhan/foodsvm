 ...
 */
package ccst.dl.ap.algorithm.matrix;

import ccst.dl.ap.algorithm.abs.AffinityPropagationAlgorithm;
import ccst.dl.ap.algorithm.abs.ConvitsVector;
import java.util.Collection;
import java.util.TreeSet;
import java.util.Vector;
import ccst.dl.ap.matrix.DoubleMatrix1D;
import ccst.dl.ap.matrix.DoubleMatrix2D;
import ccst.dl.ap.matrix.IntegerMatrix1D;
