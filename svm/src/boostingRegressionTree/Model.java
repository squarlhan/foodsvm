...
public class Model {
	...
	public static void main(String[] args) throws IOException, Exception {
		...
		String outputModelPath = "C:/Users/install/Desktop/hxs/TCM/hnc/ui/model.json";
		ArrayList<Instance> dataset = Instance
				.loadDatasetAndSchema("C:/Users/install/Desktop/hxs/TCM/hnc/all.csv");
		ArrayList<TreeNode> model = train(dataset, 3, 3);
		saveModel(model, outputModelPath);
		evaluate(outputModelPath, dataset, "C:/Users/install/Desktop/hxs/TCM/hnc/allResult.csv");
	}
...
//			System.out.println("trueValue "+dataset.get(j).trueValue);
//			System.out.println("positiveProbability "+dataset.get(j).positiveProbability);
//			System.out.println("profit "+dataset.get(j).profit);
//			System.out.println();
		}
