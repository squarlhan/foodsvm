...
//		double[][] trainset = svm.readdata("./matrix_data/allResult_0.25_6.txt");
		double[][] trainset = svm.readdata("G:/hxs/TCM/hnc/nd/missing/matrix_data/anova17.txt");
...
//		    sampleGenes[1] = new IntegerGene(gaConf, 1, 200); // c
		...
		BufferedWriter bw = new BufferedWriter(new FileWriter("G:/hxs/TCM/hnc/nd/missing/matrix_data/anovagalogcv5.txt"));
